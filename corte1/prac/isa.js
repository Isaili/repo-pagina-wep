...
for (let i = 0; i < 100; i++) {
    ...
    function generarMatricula() {
        let nuevaMatricula;
        do {
            nuevaMatricula = Math.floor(Math.random() * 230000);
    ...
    function main() {
        ...
        console.log("Alumnos aceptados:",(aceptados));
        

        console.log("Promedio de todos los alumnos:",(calcularPromedio(estudiantes)));
       

        console.log("Promedio de alumnos no reprobados:",(calcularPromedio(aceptados)));
       

        console.log("Promedio de alumnos reprobados:",(calcularPromedio(reprobados)));
        

        console.log("Alumnos aprobados de 100:",(aceptados.filter(estudiante => estudiante.calificacion >= 70).length));
